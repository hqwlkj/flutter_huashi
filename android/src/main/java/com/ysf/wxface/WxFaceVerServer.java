...
import com.ysf.wxface.entry.FaceAuthResp;
import com.ysf.wxface.entry.FaceCodeRequest;
import com.ysf.wxface.entry.FaceResult;
import com.ysf.wxface.utils.LoggerUtil;
import com.ysf.wxface.utils.ThreadUtils;
import com.ysf.wxface.utils.Tools;
            ...
            public void response(Map map) throws RemoteException {
                if (map != null) {
                    ...
                    if (!(code != null && code.equals(WxfacePayCommonCode.VAL_RSP_PARAMS_SUCCESS))) {
                        ...
                        params.put("message", "initWxPayFace 初始化失败");
                        ...
                        Map<String, Object> params = new HashMap<String, Object>();
                        params.put("message", "initWxPayFace 初始化成功");
